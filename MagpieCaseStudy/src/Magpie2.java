...
public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response = "Ah! Mauro is a great teacher.";
		}
		else if (statement.indexOf("physics") >= 0)
		{
			response = "I know a bit of physics myself";
		}
		else if (statement.indexOf("golf") >= 0)
		{
			response = "I wish I could play golf.";
		}
		else if (statement.indexOf("java") >= 0)
		{
			response = "I run on java.";
		}
